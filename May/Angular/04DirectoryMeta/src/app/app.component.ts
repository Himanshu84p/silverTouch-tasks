...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet, ChildrenComponent, ParentComponent, InterpolationComponent, AttributeBindingComponent, TwoWayDatabindComponent, PipesComponent, Comp1Component, Comp2Component, NavbarComponent, CookieDemoComponent],
