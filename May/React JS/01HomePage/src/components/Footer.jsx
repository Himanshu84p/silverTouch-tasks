...
export default function Footer() {
  return (
    <footer className="w-full my-20 bg-teal p-8 rounded-md shadow-lg">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-2 lg:px-0">
        <div className="inline-flex items-center">
          ...
          <span className="ml-4 text-lg font-bold">SkySpace</span>
        </div>
        ...
        <div className="mt-8 grid grid-cols-2 gap-6 md:mt-0 lg:w-3/4 lg:grid-cols-3">
          {Array.from({ length: 3 }).map((_, i) => (
            <div key={i} className="mb-8 lg:mb-0">
              <p className="mb-6 text-lg font-semibold text-gray-900 ">Company</p>
              <ul className="flex flex-col space-y-4 text-[14px] font-medium text-primary">
                <li>About us</li>
